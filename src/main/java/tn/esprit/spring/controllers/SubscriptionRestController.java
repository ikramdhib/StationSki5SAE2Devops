...
public class SubscriptionRestController {
    ...
    @PostMapping("/add")
    public SubscriptionTDO addSubscription(@RequestBody SubscriptionTDO subscription){
    ...
    public SubscriptionTDO getById(@PathVariable("id-subscription") Long numSubscription){
    ...
    public Set<SubscriptionTDO> getSubscriptionsByType(@PathVariable("typeSub")TypeSubscription typeSubscription){
        return subscriptionServices.getSubscriptionByType(typeSubscription);
    }
    @Operation(description = "Update Subscription ")
    @PutMapping("/update")
    public SubscriptionTDO updateSubscription(@RequestBody SubscriptionTDO subscription){
    ...
    public List<SubscriptionTDO> getSubscriptionsByDates(@PathVariable("date1") LocalDate startDate,
